...
const LoginScreen = ({ navigation }) => {
  ...
  const loginHandle = () => {
    ...
    //   axios
    //     .post("http://10.0.2.2:3000/login", requestOptions)
    //     .then((response) => {
    ...
    //       ) {
    //         if (result?.data?.userType === "ADMIN") {
    //           // Check the user type, if ADMIN navigate to Dashboard, else navigate to User Home
    //           _storeData(result.data);
    //           setIsloading(false);
      ...
      >
        <ScrollView style={{ flex: 1, width: "100%" }}>
          ...
          <View style={styles.welconeContainer}>
            <View>
              <Text style={styles.welcomeText}>Welcome to The Bloom Room </Text>
              <Text style={styles.welcomeParagraph}>
                For your beautyfull days
              </Text>
            </View>
            <View>
